...
HD_PWD='C:/Users/Abhik/Documents/my_vivado_project/square_shape/square_shape.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_shape.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source square_shape.tcl
